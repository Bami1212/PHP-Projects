...
<body>
    ...
    <section class="product spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="section-title">
                        <?php 
                         $que = "SELECT shop_name FROM user_profile WHERE shopid='$id' ";     
                         $rs = mysqli_query ($con, $que); 
                         $r=mysqli_fetch_array($rs);
                         $sname=$r[0];
                        
                        echo "<h4>".$sname.'  items'."</h4>";
            ...
            <div class="row property__gallery" id="jar" style="display:none">
                ...
                <?php 
                                                 ...
                                                 $query = "SELECT * FROM items WHERE shopid='$id' ORDER BY currenttime DESC";     
