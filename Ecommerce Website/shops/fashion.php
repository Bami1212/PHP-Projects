...
<div class="page-single movie_list">
	...
	$sql = "SELECT * FROM user_profile where shop_type='fashion'";
				...
				<?php 
                  ...
                  if (isset($_GET["page"])) {
                      ...
                      $page = 1;
                                    ...
                                    $statement = "user_profile where shop_type='fashion'";
											$query = "SELECT * FROM user_profile where shop_type='fashion' LIMIT $start_from, $per_page_record ";     
