...
if(isset($_POST['upload'])){
    ...
    $sql = "INSERT INTO items (image,name, description, price, shopid) VALUES ('$image','$name','$description','$price','$shopid')";
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li><a href="additem.php" class="active">Add Items</a></li>
    ...
    <section>
        <div class="container">
            <div class="row">
                        ...
                        <div class="panel-group category-products" id="accordian">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="shop.php">Featured Items</a></h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="shoes.php">Shoes</a></h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                ...
                <div class="col-sm-9 padding-right" id="jar">
                   
                    <div class="tab-pane">
                        <h2 class="title text-center">Add Items</h2>

                        <form autocomplete="off" method="POST" action="additem.php" enctype="multipart/form-data">
                <input type="hidden" name="size" value="1000000">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="fr" type="text" name="tname" id="tname" required>
                            </td>
                        </tr>
                        <tr>
                            <td>
