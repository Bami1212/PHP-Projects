  ...
  <center>  
    ...
    $count=1;
     ...
     <div class="pagination">    
      <?php  
        $query = "SELECT COUNT(*) FROM amharic";     
        $rs_result = mysqli_query($con, $query);     
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='view_amharic.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='view_amharic.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='view_amharic.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='view_amharic.php?page=".($page+1)."'>  Next </a>";   
        }   
...
<div id="footer">
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'view_amharic.php?page='+page;   
    }   
  </script>  
