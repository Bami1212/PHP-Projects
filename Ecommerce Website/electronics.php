    ...
    <section class="shop spad">
        <div class="container">
            <div class="row">
                ...
                $statement = "items WHERE itemtype='electronics' ORDER BY currenttime DESC";
                                             $query = "SELECT * FROM items WHERE itemtype='electronics' ORDER BY currenttime DESC LIMIT $start_from, $per_page_record";     
