    ...
    <section class="shop spad">
        <div class="container">
            <div class="row">
                ...
                $statement = "cosemotics ORDER BY currenttime DESC";
                                             $query = "SELECT * FROM cosemotics ORDER BY currenttime DESC LIMIT $start_from, $per_page_record";     
                                             $rs_result = mysqli_query ($con, $query); 
                                                while($row = mysqli_fetch_array($rs_result)){
                                                    ...
                                                    echo "<div class='product__item__pic set-bg'>";
                                                       ...
                                                       echo "<div class='product__price'>".$row['phoneno']."</div>";
                                                       echo "</div>";
                                                       echo "</div>";
                                                   echo "</div>";
                                                  }
