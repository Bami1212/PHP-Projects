...
<header class="ht-header">
	<div class="container">
		...
		<form autocomplete="off" method="post" action="games.php">
      <input type="text" name="search" placeholder="Search for Game by Title, Year" required/>
...
<div class="page-single movie_list">
	...
	echo "</p>";
										...
										?>
										<a href="games.php" class="active">See All</a>
										  ...
										  if (isset($_POST['search'])) {
											...
											if (count($results) > 0) {
											  foreach ($results as $r) {
                                               ...
                                               echo "<img src='images/game/".$r['image']."'>";
                                               echo "<div class='mv-item-infor'>";
                                                  ...
                                                  echo "</h6>";
                                                   ...
                                                   echo "<a>".$r['Minimum_requirements']."</a>";
                                                   echo "</p>";
                                               echo "</div>";
