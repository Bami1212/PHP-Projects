				...
				<div class="col-md-8 col-sm-12 col-xs-12">
					...
					<div class="flex-wrap-movielist">
						<div class="content" id="content-1" data-id='1'>
							...
							$query = "SELECT * FROM series_movies LIMIT $start_from, $per_page_record";     
						...
						<div class="content" id="content-2" data-id='2' style="display: none;">
							<div class="movie-item-style-2 movie-item-style-1">
								<img src="images/uploads/strangerthings.jpg" alt="">
								<div class="hvr-inner">
									<a href="https://en.wikipedia.org/wiki/Die_Hard"> Read more <i
											class="ion-android-arrow-dropright"></i> </a>
								</div>
								<div class="mv-item-infor">
									<h6><a href="#">Stranger Things</a></h6>
									<p class="rate"><i class="ion-android-star"></i><span>8.8</span> /10</p>
								</div>
							</div>


							<div class="movie-item-style-2 movie-item-style-1">
								<img src="images/uploads/simpsons.jpg" alt="">
								<div class="hvr-inner">
									<a href="https://en.wikipedia.org/wiki/The_Walk_(2015_film)"> Read more <i
											class="ion-android-arrow-dropright"></i> </a>
								</div>
								<div class="mv-item-infor">
									<h6><a href="#">The Simpsons</a></h6>
									<p class="rate"><i class="ion-android-star"></i><span>8.7</span> /10</p>
								</div>
							</div>
							<div class="movie-item-style-2 movie-item-style-1">
								<img src="images/uploads/friends1.jpg" alt="">
								<div class="hvr-inner">
									<a href="https://en.wikipedia.org/wiki/Blade_Runner"> Read more <i
											class="ion-android-arrow-dropright"></i> </a>
								</div>
								<div class="mv-item-infor">
									<h6><a href="#">Friends </a></h6>
									<p class="rate"><i class="ion-android-star"></i><span>8.9</span> /10</p>
								</div>
							</div>
						</div>
					</div>
					<div class="topbar-filter">
						...
						<?php  
							$con = mysqli_connect("localhost","root","","geezmovie");
      						  ...
      						  if($page>=2){   
       							     echo "<a href='movielist.php?page=".($page-1)."'>  Prev </a>";   
       									 }       
                   
       						 for ($i=1; $i<=$total_pages; $i++) {   
        						  if ($i == $page) {  
         								     $pagLink .= "<a class = 'active' href='movielist.php?page="  
                                                .$i."'>".$i." </a>";   
         										 }               
        							  else  {  
         							     $pagLink .= "<a href='movielist.php?page=".$i."'>   
                                                ".$i." </a>";     
       											   }   
       									 };     
       							 echo $pagLink;   
       						 ...
       						 if($page<$total_pages){   
          							  echo "<a href='movielist.php?page=".($page+1)."'>  Next </a>";   
       									 }   
