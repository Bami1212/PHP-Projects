...
<header class="ht-header">
	<div class="container">
					...
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							...
							<ul class="dropdown-menu level1">			
								<li><a href="index.php">Movie list</a></li>
		...
		<form autocomplete="off" method="post" action="movie.php">
      <input type="text" name="searchmovie" placeholder="Search for Movie by Title, Year" required/>
		...
		<div class="row ipad-width2">
			<div class="col-md-8 col-sm-12 col-xs-12">
                ...
                <?php 
                                     ...
                                     echo "</p>";
										?>
										<a href="movie.php" class="active">See All</a>
					<a href="movie.php" class="list"><i class="ion-ios-list-outline active"></i></a>
                </div>
										...
										// DISPLAY RESULTS
																 if (count($results) > 0) {
																   foreach ($results as $r) {
																	...
																	echo "<img src='images/movie/".$r['image']."'>";
																	echo "<div class='mv-item-infor'>";
																	   echo "<h6>";
																	   echo "<a>".$r['title'];
																	   echo "<span>".'('.$r['year'].')'."</span>";
																	   echo "</a>";
																	   echo "</h6>";
																	   echo "<p class='rate'>";
																	   ...
																	   echo "<span>".$r['rating'].'/10'."</span>";
																		echo "</p>";
																		echo "<p class='describe'>".$r['description']."</p>";
																		echo "<p class='run-time'>".'Run Time: '.$r['runtime']."</p>";
																		echo "<p>".'Director: ';
																		echo "<a>".$r['director']."</a>";
																		echo "</p>";
																		echo "<p>".'Stars: ';
											 ...
											 echo "<div class='movie-item-style-2'>";
												...
												echo "<div class='mv-item-infor'>";
												   ...
												   echo "<span>".$row['rating'].'/10'."</span>";
													...
													echo "<p class='run-time'>".'Run Time: '.$row['runtime']."</p>";
													echo "<p>".'Director: ';
													echo "<a>".$row['director']."</a>";
													echo "</p>";
													echo "<p>".'Stars: ';
													echo "<a>".$row['stars']."</a>";
													echo "</p>";
				...
				<div class="topbar-filter">
					...
					<select id="choosemovienum">
						<option value="5" selected="selected">5 Movies</option>
